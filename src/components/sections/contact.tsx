      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <FadeIn>
          <div className="rounded-3xl border border-border bg-card p-8 text-center shadow-soft sm:p-14">
            ...
            <h2 id="contact-heading" className="mx-auto mt-3 max-w-2xl font-display text-3xl font-semibold tracking-tight sm:text-4xl">
              Let's talk
            </h2>
            <p className="mx-auto mt-3 max-w-xl text-muted-foreground">
              Placeholder line about being open to roles and conversations.
            </p>
